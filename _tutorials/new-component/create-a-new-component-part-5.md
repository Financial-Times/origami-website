...
In part five we will add interactivity to our component using JavaScript. We'll increment a counter within the component every time its button is clicked.
